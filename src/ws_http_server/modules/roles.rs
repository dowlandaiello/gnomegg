...
pub trait Provider {
    ...
    fn user_has_role(user_id: u64, role: &Role) -> Result<bool, ProviderError>;
    ...
    /// * `user_id` - The ID of the user whose role should be checked
    /// * `role` - The role that the user should have
    fn give_role(user_id: u64, role: Role) -> Result<(), ProviderError>;
    ...
    fn remove_role(user_id: u64, role: Role) -> Result<(), ProviderError>;
    ...
    fn purge_roles(user_id: u64) -> Result<Vec<Role>, ProviderError>;
    ...
    fn roles_for_user(user_id: u64) -> Result<Vec<Role>, ProviderError>;
}
